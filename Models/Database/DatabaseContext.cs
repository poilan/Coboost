    ...
    public class DatabaseContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            builder.Entity<UserSession>()
                .HasKey(us => new { us.UserId, us.SessionId }); // Composite Key for User-Session JOIN
            builder.Entity<UserFolder>()
                .HasKey(uf => new { uf.FolderId, uf.SessionId, uf.UserId }); // Composite Key for Session-Folder-User JOIN

            // The index of the JOIN table starts at 100000
            builder.HasSequence<int>("SessionOrder_seq", "dbo")
                .StartsAt(100000)
                .IncrementsBy(1);
