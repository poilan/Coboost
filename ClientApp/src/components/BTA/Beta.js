    ...
    agreement() {
        return (
            <div style={{ textAlign: "center", marginLeft: "5%", marginRight: "5%" }} >
                ...
                <Typography style={{ position: "relative", width: "50%", left: "50%", transform: "translateX(-50%)", textAlign: "left", display: "block" }
}
                            variant="p" >
