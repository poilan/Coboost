    ...
    rightNav() {
        return (
            <RightNav activeKey="/"
                ...
                <Nav.Item>
                    {this.state.loggedIn
                        ? <LoginButton href="/dashboard">Get Started</LoginButton>
        ...
        return (
            <LandingContainer>
                <LeftHalf mobile={Mobile}>
                    <LeftTitle id="ParticipantText"
                        mobile={Mobile}>
                        The Tool for
                        <br />
                        Digital Co-Creation
                    </LeftTitle>
                    <LeftText id="JoinText"
                        mobile={Mobile}>
